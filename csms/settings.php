...
?>
		...
		<form action="settings.php" method="post">
			...
			<label for="email">Email:</label> <input id="email" type="text" value="<?php echo $user['email']; ?>" /></p>
			<p><label for="oldpass">Current Password:</label> <input id="oldpass" type="password" value="" /><br />
			<label for="newpass">New Password:</label> <input id="newpass" type="password" value="" /><br />
			<label for="newpassc">New Password Confirm:</label> <input id="newpassc" type="password" value="" /></p>
